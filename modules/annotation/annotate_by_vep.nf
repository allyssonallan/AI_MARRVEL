...
// This process annotates a VCF file using the Ensembl Variant Effect Predictor (VEP).
// It uses various plugins and custom databases for annotation, including gnomAD, ClinVar,
// HGMD, REVEL, SpliceAI, CADD, and dbNSFP.
