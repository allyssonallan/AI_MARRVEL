...
// This process converts a gVCF file to a standard VCF format using GATK
// It performs several steps including annotation, sorting, genotyping, and filtering
// The output is a gzipped VCF file and its index, ready for further analysis
